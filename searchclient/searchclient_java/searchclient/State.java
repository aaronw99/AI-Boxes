...
public class State
{
    ...
    */
    ...
    public static int[] boxGoalRows;
    public static int[] boxGoalCols;
    public static char[] boxGoalLetters;

    public static int[] agentGoalRows;
    public static int[] agentGoalCols;
     ...
     */
    public State(int[] agentRows, int[] agentCols, char[][] boxes)
    {
    ...
    {
        for (int i = 0; i < State.boxGoalRows.length; ++i)
        {
            int goalRow = State.boxGoalRows[i];
            int goalCol = State.boxGoalCols[i];
            char goalLetter = State.boxGoalLetters[i];

            if (this.boxes[goalRow][goalCol] != goalLetter)
            {
                return false;
            }
        }

        for (int i = 0; i < State.agentGoalRows.length; ++i)
        {
            int goalRow = State.agentGoalRows[i];
            int goalCol = State.agentGoalCols[i];

            if (goalRow != -1 && (this.agentRows[i] != goalRow || this.agentCols[i] != goalCol))
            {
                return false;
            }
        }
    ...
    private boolean isApplicable(int agent, Action action)
    {
        ...
        switch (action.type)
        {
            ...
            case Push:
                ...
                if (box == 0 || agentColor != State.boxColors[box - 'A'])
                {
                    return false;
                }
    ...
    public String toString()
    {
        ...
        for (int row = 0; row < State.walls.length; row++)
        {
            for (int col = 0; col < State.walls[row].length; col++)
            {
